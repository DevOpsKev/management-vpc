...
functionality you're adding in your contribution. Check out the [tests](https://github.com/DevOpsKev/management-vpc/tree/master/test) folder for instructions on running the 
automated tests. 
...
1. The output of your automated test run, preferably in a [GitHub Gist](https://gist.github.com/). We cannot run 
   ...
   concerns](https://circleci.com/docs/2.0/security/), so we need you to manually provide this 
